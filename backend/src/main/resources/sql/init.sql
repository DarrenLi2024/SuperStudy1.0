...
-- 985/双一流
('北京大学', '/logos/beida.png', '985/双一流', 'both'),
('清华大学', '/logos/tsinghua.png', '985/双一流', 'both'),
('复旦大学', '/logos/fudan.png', '985/双一流', 'both'),
('上海交通大学', '/logos/sjtu.png', '985/双一流', 'both'),
('浙江大学', '/logos/zju.png', '985/双一流', 'both'),
('南京大学', '/logos/nju.png', '985/双一流', 'both'),
('武汉大学', '/logos/whu.png', '985/双一流', 'both'),
('中山大学', '/logos/zhongshan.png', '985/双一流', 'both'),
-- 211
('郑州大学', '/logos/zhengzhou.png', '211', 'both'),
('南昌大学', '/logos/nanchang.png', '211', 'both'),
('云南大学', '/logos/yunnan.png', '211', 'both'),
('广西大学', '/logos/guangxi.png', '211', 'both'),
('贵州大学', '/logos/guizhou.png', '211', 'both'),
('海南大学', '/logos/hainan.png', '211', 'both'),
('宁夏大学', '/logos/ningxia.png', '211', 'both'),
-- 普通一本
('河南大学', '/logos/henan.png', '普通一本', 'both'),
('河北师范大学', '/logos/hebei.png', '普通一本', 'both'),
('山西大学', '/logos/shanxi.png', '普通一本', 'both'),
('安徽师范大学', '/logos/anhui.png', '普通一本', 'both'),
('福建师范大学', '/logos/fujian.png', '普通一本', 'both'),
('江西师范大学', '/logos/jiangxi.png', '普通一本', 'both'),
('湖北大学', '/logos/hubei.png', '普通一本', 'both'),
('湖南科技大学', '/logos/hunan.png', '普通一本', 'both'),
-- 公办二本
('洛阳师范学院', '/logos/luoyang.png', '公办二本', 'both'),
('安阳师范学院', '/logos/anyang.png', '公办二本', 'both'),
('南阳理工学院', '/logos/nanyang.png', '公办二本', 'both'),
('信阳师范大学', '/logos/xinyang.png', '公办二本', 'both'),
('周口师范学院', '/logos/zhoukou.png', '公办二本', 'both'),
('黄淮学院', '/logos/huanghuai.png', '公办二本', 'both'),
('平顶山学院', '/logs/pingdingshan.png', '公办二本', 'both');
